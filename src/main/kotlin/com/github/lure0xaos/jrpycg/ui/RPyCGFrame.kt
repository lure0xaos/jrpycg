            ...
            add(
                JButtonPanel(
                        ...
                        JMenuItem(resources[LC_BOTTOM_LOAD]) {
                            storagePanel.selectLoadFile(this)?.also { path ->
                                storagePanel.loadAs(path)
                                    ...
                                    .onFailure { error ->
                                        updateButtons()
                                        this@RPyCGFrame.alertError(error, resources[LC_ERROR_LOAD])
                                    }
                            }
                        },
                    ...
                    JButton(resources[LC_BOTTOM_CREATE_TEMPLATE], ResIcon.TEMPLATE.icon) {
                        if (builder.isEmpty() || this@RPyCGFrame.confirm(resources[LC_CONFIRM_CLOSE]) == true) {
                    ...
                    JDropdownButton(
                        ...
                        JMenuItem(resources[LC_BOTTOM_SAVE]) {
                            storagePanel.save(builder.getModel())
                                ...
                                .onFailure { error ->
                                    updateButtons()
                                    this@RPyCGFrame.alertError(error, resources[LC_ERROR_SAVE])
                                }
                        }.also { btnSave = it },
